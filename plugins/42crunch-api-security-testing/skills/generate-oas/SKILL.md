...
If yes, **ask the user directly** for the root directory:
...
If **Postman**, **ask the user directly** twice, as two separate calls:
...
If **Insomnia**, **ask the user directly** twice, as two separate calls:
...
**Ask the user directly** to confirm the output file path, defaulting to:
