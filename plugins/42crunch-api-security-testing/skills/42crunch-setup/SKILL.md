...
- If not configured (or replacing): walk the user through the guided flow:
  - **How do you access 42Crunch — token (Free Trial / Individual / Individual Pro / Team) or Platform account (Enterprise)?**
    ...
    - Token → **Do you already have your token?**
      - Yes → enter token
      - No → **Start a Free Trial** (show registration link, `[42Crunch Free Trial](https://42crunch.com/freemium/?source=codex)`) or **view paid plans** (Individual / Individual Pro / Team / Enterprise pricing link) — either way, stop and wait for the user to return
